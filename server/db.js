    ...
    async reloadFromSupabase() {
        ...
        try {
            ...
            this.trains = (trains || []).map(t => ({
                ...
                corridor: this.corrMap[t.corridor_id] || null,
            ...
            this.windows = (windows || []).map(w => ({
                ...
                corridor: this.corrMap[w.corridor_id] || null,
            ...
            this.requests = (reqs || []).map(r => ({
                ...
                corridor: this.corrMap[r.corridor_id] || null,
            ...
            if (!planErr && plans) {
                this.blockPlans = plans.map(p => ({
                    ...
                    plan_id: p.plan_code,
                    name: p.name,
                    corridor: this.corrMap[p.corridor_id] || null,
                    status: p.status,
            ...
            if (!confErr && confs) {
                this.conflicts = confs.map(c => ({
                    ...
                    severity: c.severity,
                    corridor: this.corrMap[c.corridor_id] || null,
